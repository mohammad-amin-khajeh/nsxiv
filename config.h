...
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "jetbrainsmono nf-11-light" };
 ...
 * higher memory usage.
 */
static const int CACHE_SIZE_MEM_PERCENTAGE = 6;          /* use 6% of total memory for cache */
static const int CACHE_SIZE_LIMIT = 512 * 1024 * 1024;   /* but not above 512MiB */
...
static const keymap_t keys[] = {
	...
	{ Mod1Mask,     XK_Left,          i_scroll,             DIR_LEFT },
	{ 0,            XK_j,             i_scroll,             DIR_DOWN },
	{ Mod1Mask,     XK_Down,          i_scroll,             DIR_DOWN },
	{ 0,            XK_k,             i_scroll,             DIR_UP },
	{ Mod1Mask,     XK_Up,            i_scroll,             DIR_UP },
	{ 0,            XK_l,             i_scroll,             DIR_RIGHT },
	// { 0,            XK_Right,         i_scroll,             DIR_RIGHT },
	{ Mod1Mask,     XK_Right,         i_scroll,             DIR_RIGHT },
